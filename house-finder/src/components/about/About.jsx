...
const About = () => {
  return (
    <div className='mt-10 h-[100vh]'>
      <h1 className='font-black text-black text-3xl p-3'>Services</h1>
      <div>

      </div>
      <div className='grid  grid-cols-1 md:grid-cols-3 gap-5 justify-around items-center mb-4'>
        <div className='w-full shadow-md shadow-black p-2 mt-5 mb-5 h-full'>
          <h1 className='font-semibold text-black p-2'>Clients</h1>
        ...
        <div className='w-full shadow-md shadow-black p-2  h-full'>
          <h1 className='font-semibold text-black p-2'>Property Agents</h1>
          <p>
        ...
        <div className='w-full shadow-md shadow-black p-2 mt-5  mb-5 h-full'>
          <h1 className='font-semibold text-black p-2'>Connecting Clients to Property Dealers</h1>
          <p className='text-[15px]'>
