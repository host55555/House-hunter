            ...
            <div className="banner">
                <div className='text-center text-white pt-72  md:pt-52'>
                    ...
                    <div className='m-[70px]'>
                        <Link to='houses' className='text-black bg-white m-2 md:m-4 rounded-md p-1 md:p-2'><span></span>let's hunt</Link>
                        <Link to='about' className='text-black bg-white m-2 md:m-4 rounded-md p-1 md:p-2'><span></span>About us</Link>
                    </div>
                </div>
            </div>
            <Houses/>
